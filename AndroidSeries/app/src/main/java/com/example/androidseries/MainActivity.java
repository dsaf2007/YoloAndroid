...
public class MainActivity extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener2 {
    ...
    private static String getPath(String file, Context context) {
        ...
        try {
            ...
            Log.i("OpenCV/Sample/MobileNet", "Failed to upload a file");
        }
        return "";
    }
    ...
    public Mat onCameraFrame(CameraBridgeViewBase.CvCameraViewFrame inputFrame) {
        ...
        if (startYolo == true) {
            ...
            Mat imageBlob = Dnn.blobFromImage(frame, 0.00392, new Size(608,608),new Scalar(0, 0, 0),/*swapRB*/false, /*crop*/false);
            ...
            if (ArrayLength>=1) {
                ...
                for (int i = 0; i < ind.length; ++i) {
                    ...
                    List<String> cocoNames = Arrays.asList("bottle");
                    ...
                    Imgproc.putText(frame,"a bottle",box.tl(),Core.FONT_HERSHEY_SIMPLEX, 2, new Scalar(255,255,0),2);
